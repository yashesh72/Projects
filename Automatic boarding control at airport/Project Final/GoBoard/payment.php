...
<body>
    <div class="container-fluid">
        ...
        <div class="creditCardForm">
            <div class="heading">
                <?php echo'<h2>Confirm Payment of Rs.'.$total.'</h2>' ?>
            </div>
            <div class="payment">
                <form method="get" action="payquery.php">
                    ...
                    <div class="form-group" id="pay-now">
                        <button type="submit" class="btn btn-default" formaction="payquery.php">Confirm</button>
                    </div>
                </form>
            </div>
        </div>
